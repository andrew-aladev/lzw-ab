...
typedef lzws_result_t (*lzws_test_decompressor_t)(lzws_decompressor_state_t* state_ptr, size_t buffer_length,
                                                  va_list args);

typedef lzws_result_t (*lzws_test_compressor_and_decompressor_t)(lzws_compressor_state_t*   compressor_state_ptr,
