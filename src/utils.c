...
extern inline void  lzws_write_byte(lzws_byte_fast_t byte, lzws_byte_t** destination_ptr,
                                    size_t* destination_length_ptr);
extern inline void  lzws_fill_array(void* array, size_t size_of_item, size_t length, const void* item_ptr,
                                    bool item_bytes_are_identical);
extern inline void* lzws_allocate_array(lzws_byte_fast_t size_of_item, size_t length, const void* item_ptr,
                                        bool item_is_zero, bool item_bytes_are_identical);
