...
extern inline void lzws_compressor_initialize_dictionary(lzws_compressor_dictionary_t* dictionary_ptr, lzws_code_fast_t first_free_code, const lzws_compressor_options_t* options);
...
extern inline void lzws_compressor_free_dictionary(lzws_compressor_dictionary_t* dictionary_ptr, const lzws_compressor_options_t* options);
