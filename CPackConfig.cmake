...
if (LZWS_CLI)
  set (CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_PACKAGE_DEPENDS}, libpopt-dev")
  set (CPACK_RPM_PACKAGE_REQUIRES "${CPACK_RPM_PACKAGE_REQUIRES}, popt-devel")
  set (CPACK_FREEBSD_PACKAGE_DEPS "${CPACK_FREEBSD_PACKAGE_DEPS}, devel/popt")
endif ()
